...
mixin _$ProductsState {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(List<Map> products, int page, String typePage)
        initial,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(List<Map> products, int page, String typePage)? initial,
...
abstract class _$$IntialImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Map> products, int page, String typePage});
}
...
class _$IntialImpl implements Intial {
  const _$IntialImpl(final List<Map> products, this.page, this.typePage)
      : _products = products;

  final List<Map> _products;
  @override
  List<Map> get products {
...
abstract class Intial implements ProductsState {
  const factory Intial(
          final List<Map> products, final int page, final String typePage) =
      _$IntialImpl;
