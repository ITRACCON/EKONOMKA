...
mixin _$AdminState {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(List<UserModel> users, List<OrderUser> orders)
        initialStats,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(List<UserModel> users, List<OrderUser> orders)?
        initialStats,
...
abstract class _$$IntialStatsImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<UserModel> users, List<OrderUser> orders});
}
...
class _$IntialStatsImpl implements IntialStats {
  const _$IntialStatsImpl(
      final List<UserModel> users, final List<OrderUser> orders)
      : _users = users,
        _orders = orders;
  ...
  @override
  String toString() {
    return 'AdminState.initialStats(users: $users, orders: $orders)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return initialStats(users, orders);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return initialStats?.call(users, orders);
  }
